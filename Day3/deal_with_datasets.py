...
# 数据集路径
dataset_dir = r'D:\code\HuaQing\Day3\dataset\Images'  # 替换为你的数据集路径
train_dir = r'D:\code\HuaQing\Day3\dataset\train'  # 训练集输出路径
val_dir = r'D:\code\HuaQing\Day3\dataset\val'  # 验证集输出路径
